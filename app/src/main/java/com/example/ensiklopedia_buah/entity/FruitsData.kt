package com.example.ensiklopedia_buah.entity
...
object FruitsData {
    ...
    private val fruitDetails = arrayOf(
        "Alpukat bertipe buni, memiliki kulit lembut tak rata berwarna hijau tua hingga ungu kecoklatan, " +
                "tergantung pada varietasnya. Daging buah alpokat berwarna hijau muda dekat kulit dan kuning muda dekat biji " +
